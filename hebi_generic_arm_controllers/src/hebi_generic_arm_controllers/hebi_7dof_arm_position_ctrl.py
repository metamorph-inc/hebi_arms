...
'''
# Name: hebi_7dof_arm_position_ctrl.py
...
def parse_args(args):
    ...
    parser.add_argument('-hebi_wrist1_family', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist1_name', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist2_family', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist2_name', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist3_family', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist3_name', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist4_family', type=str, required=True, help="")
    parser.add_argument('-hebi_wrist4_name', type=str, required=True, help="")
...
def main():
    ...
    hebi_families = [parser.hebi_base_family,
                     ...
                     parser.hebi_wrist1_family,
                     parser.hebi_wrist2_family,
                     parser.hebi_wrist3_family,
                     parser.hebi_wrist4_family]
    hebi_names = [parser.hebi_base_name,
                  parser.hebi_shoulder_name,
                  parser.hebi_elbow_name,
                  parser.hebi_wrist1_name,
                  parser.hebi_wrist2_name,
                  parser.hebi_wrist3_name,
                  parser.hebi_wrist4_name]
